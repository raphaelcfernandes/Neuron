...
${OBJECTDIR}/_ext/5c0/CreateNumber.o: ../CreateNumber.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/CreateNumber.o ../CreateNumber.cpp

${OBJECTDIR}/_ext/5c0/Perceptron.o: ../Perceptron.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Perceptron.o ../Perceptron.cpp
